...
import AddEdit from "@/app/components/admin-panel/years/AddEdit";
...
function YearsPageInner() {
  ...
  const receivedData = (item: any) => {
    handleAfterSave(item as Year, modalTitle === "Edit");
    setIsOpenModal(false);
  };
