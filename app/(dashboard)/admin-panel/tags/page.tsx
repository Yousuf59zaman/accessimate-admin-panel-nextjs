...
import AddEdit from "@/app/components/admin-panel/tags/AddEdit";
...
function TagsPageInner() {
  ...
  const receivedData = (item: any) => {
    handleAfterSave(item as Tag, modalTitle === "Edit");
    setIsOpenModal(false);
  };
