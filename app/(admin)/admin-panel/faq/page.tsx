...
function FaqPageInner() {
  ...
  const editHandler = (item: FaqItem) => {
    setEditItem(item);
    setModalTitle("Edit");
    setIsOpenModal(true);
  };
  ...
  const receivedData = (item: any) => {
    handleAfterSave(item as FaqItem, modalTitle === "Edit");
    setIsOpenModal(false);
  };
              ...
              >
                ...
                <div className="flex-1 space-y-3">
                  ...
                  <div className="flex gap-2">
                    ...
                    <div className="h-4 w-[88px] animate-pulse rounded bg-slate-100 dark:bg-slate-800" />
                  </div>
                </div>
          ...
          <section className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-2xl space-y-3">
              ...
              <p className="max-w-xl text-sm leading-6 text-slate-500 dark:text-slate-300 sm:text-[15px]">
                Organize frequently asked questions into clear categories with
                the same premium management experience used across the admin
                panel.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-3 xl:flex-row xl:items-center">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  placeholder="Filter by question, title or category..."
                />
              </div>
              ...
              <div className="flex flex-col gap-3 sm:flex-row xl:w-auto">
                ...
                <button
                  ...
                  aria-label="Refresh filtered faq"
                >
            ...
            {isLoading ? (
              ...
              <div className="rounded-[1.85rem] border border-dashed border-slate-300/80 bg-white/80 px-6 py-16 text-center shadow-[0_18px_45px_-36px_rgba(15,23,42,0.28)] dark:border-slate-700 dark:bg-slate-900/70">
                ...
                <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-slate-500 dark:text-slate-400">
                  Adjust your search or status filters to find the right FAQ
                  entries.
                </p>
              </div>
            ) : (
              groupedData.map((group, groupIndex) => {
                ...
                const theme = faqAccentThemes[groupIndex % faqAccentThemes.length];
                      ...
                      <div className="border-t border-slate-100 px-4 pb-4 pt-1 dark:border-slate-800 sm:px-5">
                        ...
                        <div className="space-y-3">
                          {group.items.map((item, itemIndex) => {
                            ...
                            const secondaryText =
                              item.title && item.title !== primaryText
                                ? item.title
                                : "";
                                ...
                                <div className="flex items-center gap-2 lg:justify-center">
                                  ...
                                  permissions.delete ? (
                                    <button
                                      ...
                                      aria-label={`Restore ${primaryText}`}
                                    >
          ...
          {!isLoading && (
            <footer className="flex flex-col gap-4 border-t border-slate-200/80 pt-4 text-xs text-slate-400 dark:border-slate-800 dark:text-slate-500 sm:flex-row sm:items-center sm:justify-between">
              <p className="font-medium tracking-[0.04em]">
                Showing {totalFaqs} FAQ entries across {groupedData.length}{" "}
                categories
              </p>
