...
import AddEdit from "@/app/components/admin-panel/users/AddEdit";
...
function UsersPageInner() {
  ...
  const receivedData = (item: any) => {
    handleAfterSave(item as User, modalTitle === "Edit");
    setIsOpenModal(false);
  };
        ...
        <tr key={idx}>
          <td className="text-gray-800 dark:text-gray-200 text-start p-3">
            <div className="flex items-center gap-2">
              <div className="w-24 h-24 bg-gray-200 dark:bg-gray-700 rounded-md animate-pulse" />
                          ...
                          <td className="text-gray-800 dark:text-gray-200 text-start p-3">
                            <div className="flex items-center gap-2">
                              <img
                                ...
                                alt={item.user_info?.first_name || "User"}
