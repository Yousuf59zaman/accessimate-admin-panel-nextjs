...
function EventCategoriesPageInner() {
  ...
  const {
    ...
    handleAfterSave,
    resetPagination,
  } = useAdminCrud<EventCategory>({
    apiEndpoint: "admin/event-categories/all",
    apiBase: "admin/event-categories",
    pageSize: 10,
  });
  ...
  const editHandler = (item: EventCategory) => {
    setEditItem(item);
    setModalTitle("Edit");
    setIsOpenModal(true);
  };
  ...
  const receivedData = (item: any) => {
    handleAfterSave(item as EventCategory, modalTitle === "Edit");
    setIsOpenModal(false);
  };
                    ...
                    <tbody>
                      {data.map((item) => (
                        ...
                        >
                          ...
                          <td className="text-gray-800 dark:text-gray-200 text-start p-3">
                            {item.parent ? item.parent.title : "None"}
                          </td>
                          <td className="text-gray-800 dark:text-gray-200 text-start p-3">
                            {item.slug}
                          </td>
