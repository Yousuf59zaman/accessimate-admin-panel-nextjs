...
function PortfolioCategoriesPageInner() {
  ...
  const {
    ...
    handleAfterSave,
    resetPagination,
  } = useAdminCrud<PortfolioCategory>({
    apiEndpoint: "admin/portfolio-categories/all",
    apiBase: "admin/portfolio-categories",
    pageSize: 10,
  });
  ...
  const editHandler = (item: PortfolioCategory) => {
    setEditItem(item);
    setModalTitle("Edit");
    setIsOpenModal(true);
  };
  ...
  const receivedData = (item: any) => {
    handleAfterSave(item as PortfolioCategory, modalTitle === "Edit");
    setIsOpenModal(false);
  };
                ...
                <table className="table-auto w-full">
                  <thead className="sticky z-10 top-0 bg-gray-50 dark:bg-gray-900">
                    <tr>
                      ...
                      <th className="text-left p-3" style={{ width: "20%" }}>
                        <span className="text-gray-800 dark:text-gray-200">
                          Slug
                        </span>
                      </th>
