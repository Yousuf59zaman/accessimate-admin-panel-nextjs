...
function TutorialPageInner() {
  ...
  const {
    ...
    handleAfterSave,
    resetPagination,
  } = useAdminCrud<TutorialItem>({
    apiEndpoint: "admin/tutorials/all",
    apiBase: "admin/tutorials",
    pageSize: 10,
  });
  ...
  const onStatusChange = useCallback(
    ...
    [optionsList, resetPagination, setStatus],
  );
  ...
  const editHandler = (item: TutorialItem) => {
    setEditItem(item);
    setModalTitle("Edit");
    setIsOpenModal(true);
  };
  ...
  const receivedData = (item: any) => {
    handleAfterSave(item as TutorialItem, modalTitle === "Edit");
    setIsOpenModal(false);
  };
        ...
        >
          <div className="flex items-center justify-between px-6 py-5">
            <div className="flex items-center gap-4">
              ...
              <div className="h-6 w-[104px] animate-pulse rounded-lg bg-slate-100 dark:bg-slate-800" />
            </div>
          ...
          <section className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-2xl space-y-3">
              ...
              <p className="max-w-xl text-sm leading-6 text-slate-500 dark:text-slate-300 sm:text-[15px]">
                Organize educational content, walkthroughs, and category-based
                tutorials in the same refined management surface used across the
                admin panel.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-3 xl:flex-row xl:items-center">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  placeholder="Filter by tutorial title, slug or category..."
                />
              </div>
              ...
              <div className="flex flex-col gap-3 sm:flex-row xl:w-auto">
                ...
                <button
                  ...
                  aria-label="Refresh filtered tutorials"
                >
          ...
          <section className="space-y-5">
            {isLoading ? (
              ...
              groupedData.map((group, groupIndex) => {
                ...
                const theme =
                  tutorialAccentThemes[
                    groupIndex % tutorialAccentThemes.length
                  ];
          ...
          {!isLoading && (
            <footer className="flex flex-col gap-4 border-t border-slate-200/80 pt-4 text-xs text-slate-400 dark:border-slate-800 dark:text-slate-500 sm:flex-row sm:items-center sm:justify-between">
              <p className="font-medium tracking-[0.04em]">
                Showing {totalTutorials} tutorial entries across{" "}
                {groupedData.length} categories
              </p>
