...
function TrustedBrandsPageInner() {
  ...
  const {
    ...
    handleAfterSave,
    resetPagination,
  } = useAdminCrud<TrustedBrand>({
    apiEndpoint: "admin/trusted-brands/all",
    apiBase: "admin/trusted-brands",
    pageSize: 10,
  });
  ...
  const editHandler = (item: TrustedBrand) => {
    setEditItem(item);
    setModalTitle("Edit");
    setIsOpenModal(true);
  };
  ...
  const receivedData = (item: any) => {
    handleAfterSave(item as TrustedBrand, modalTitle === "Edit");
    setIsOpenModal(false);
  };
              ...
              <div className="custom_table overflow-auto border-b border-gray-200 dark:border-gray-700">
                <table className="table-auto w-full">
                  <thead className="sticky z-10 top-0 bg-gray-50 dark:bg-gray-900">
                    <tr>
                      <th className="text-left p-3" style={{ width: "80%" }}>
                      ...
                      {data.map((item) => (
                        ...
                        >
                          <td className="text-gray-800 dark:text-gray-200 text-start p-3">
                            <div className="flex items-center gap-2">
                              <img
                                src={item.photo || "/svg/not-found-img.svg"}
