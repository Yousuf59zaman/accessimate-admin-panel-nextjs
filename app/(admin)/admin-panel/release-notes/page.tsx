...
function ReleaseNotesPageInner() {
  ...
  const {
    ...
    handleAfterSave,
    resetPagination,
  } = useAdminCrud<ReleaseNote>({
    apiEndpoint: "admin/release-notes/all",
    apiBase: "admin/release-notes",
    pageSize: 10,
  });
  ...
  const editHandler = (item: ReleaseNote) => {
    setEditItem(item);
    setModalTitle("Edit");
    setIsOpenModal(true);
  };
  ...
  const receivedData = (item: any) => {
    handleAfterSave(item as ReleaseNote, modalTitle === "Edit");
    setIsOpenModal(false);
  };
              ...
              <div className="custom_table overflow-auto border-b border-gray-200 dark:border-gray-700">
                <table className="table-auto w-full">
                  <thead className="sticky z-10 top-0 bg-gray-50 dark:bg-gray-900">
                    <tr>
                      <th className="text-left p-3" style={{ width: "35%" }}>
