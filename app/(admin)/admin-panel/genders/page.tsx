...
import AddEdit from "@/app/components/admin-panel/genders/AddEdit";
...
function GendersPageInner() {
  ...
  const {
    ...
    apiEndpoint: "admin/genders/all",
    apiBase: "admin/genders",
    pageSize: 10,
  });
  ...
  const [editItem, setEditItem] = useState<Gender | null>(null);
  ...
  const receivedData = (item: any) => {
    handleAfterSave(item as Gender, modalTitle === "Edit");
    setIsOpenModal(false);
  };
