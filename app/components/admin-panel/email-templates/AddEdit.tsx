...
interface AddEditProps {
  ...
  modalTitle: string;
  onClose: () => void;
  onSave: (item: EmailTemplate) => void;
}
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const result = await fetchAdmin<SubmitApiResponse>(
        isEdit ? `admin/email-templates/${item?.id}` : "admin/email-templates",
        ...
        <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-lg mx-4 animate-modal-enter max-h-[90vh] overflow-y-auto">
          ...
          <div className="grid grid-cols-1 gap-4 p-6">
            <div className="flex items-center gap-4">
              <label className="font-semibold w-28 text-gray-900 dark:text-white">
                Name
              </label>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-auto">
                <input
                  ...
                  placeholder="i.e. Welcome to our platform"
                  className={inputClass("email_subject")}
                  autoComplete="off"
                  onFocus={() =>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-auto">
                <textarea
                  ...
                  className={inputClass("email_body")}
                  rows={5}
                  placeholder="i.e. Welcome to our platform"
                  onFocus={() =>
                    setValidationErrors((prev) => ({ ...prev, email_body: "" }))
                  }
                />
