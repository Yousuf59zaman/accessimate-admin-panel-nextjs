...
const emptyForm: FormData = { language_name: "", status: 0 };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const result = await fetchAdmin<SubmitApiResponse>(
        isEdit ? `admin/languages/${item?.id}` : "admin/languages",
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-auto">
                <input
                  ...
                  className={inputClass("language_name")}
                  autoComplete="off"
                  onFocus={() =>
                ...
                />
                {validationErrors.language_name && (
