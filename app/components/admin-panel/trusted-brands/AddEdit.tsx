...
interface AddEditProps {
  isOpen: boolean;
  item: TrustedBrand | null;
  modalTitle: string;
  onClose: () => void;
  onSave: (item: TrustedBrand) => void;
}

const emptyForm: FormData = { title: "", slug: "", photo: "", status: 0 };
