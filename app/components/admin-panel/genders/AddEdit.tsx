...
interface AddEditProps {
  ...
  modalTitle: string;
  onClose: () => void;
  onSave: (item: GenderItem) => void;
}

const emptyForm: FormData = { gender_name: "", status: 0 };
...
export default function AddEdit({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const url = isEdit ? `admin/genders/${item?.id}` : "admin/genders";
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-auto">
                <input
                  ...
                  onChange={(e) => updateField("gender_name", e.target.value)}
                  placeholder="i.e. Male"
                  className={inputClass("gender_name")}
                  autoComplete="off"
                  onFocus={() =>
