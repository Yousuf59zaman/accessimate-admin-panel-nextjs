  ...
  useEffect(() => {
    if (item && Object.keys(item).length > 0) {
      ...
      setFormData({
        ...
        url: item.url || "",
        hierarchy: String(item.hierarchy || ""),
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const result = await fetchAdmin<SubmitApiResponse>(
        isEdit ? `admin/social-links/${item?.id}` : "admin/social-links",
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-auto">
                <input
                  ...
                  className={inputClass("social_title")}
                  autoComplete="off"
                  onFocus={() =>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-auto">
                <input
                  ...
                  placeholder="i.e 1"
                  className={inputClass("hierarchy")}
                  autoComplete="off"
                  onFocus={() =>
                    setValidationErrors((prev) => ({ ...prev, hierarchy: "" }))
                  }
                />
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-auto">
                <input
                  ...
                  placeholder="i.e header"
                  className={inputClass("display")}
                  autoComplete="off"
                  onFocus={() =>
                    setValidationErrors((prev) => ({ ...prev, display: "" }))
                  }
                />
              ...
              <div className="grid grid-cols-2 gap-4 w-full">
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2">
                    <i
                      className={`${formData.icon} text-[40px] cursor-pointer`}
